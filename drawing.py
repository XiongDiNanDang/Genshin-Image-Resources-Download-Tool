...
def drawing():
    chara_name_list = ["七七", "丽莎", "九条裟罗", "云堇", "五郎", "优菈", "八重神子", "凝光", "凯亚", "刻晴", "北斗", "可莉", "埃洛伊", "安柏", "宵宫",
                       "托马", "旅行者（无属性）", "早柚", "枫原万叶", "温迪", "烟绯", "珊瑚宫心海", "班尼特", "琴", "甘雨",
    ...
    for i in range(0, len(chara_name_list)):
        URL = "https://bbs.hoyolab.com/hoyowiki/picture/character/" + \
              chara_name_list[i] + "/avatar.png"  # 网址
        ...
        spritePage = open("角色立绘\\" + doc_name, "wb")
