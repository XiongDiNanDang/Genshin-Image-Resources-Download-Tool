...
chara_name_list = ["七七", "丽莎", "九条裟罗", "云堇", "五郎", "优菈", "八重神子", "凝光", "凯亚", "刻晴", "北斗", "可莉", "埃洛伊", "安柏", "宵宫", "托马", "旅行者（无属性）", "早柚", "枫原万叶", "温迪", "烟绯", "珊瑚宫心海", "班尼特", "琴", "甘雨", "申鹤", "砂糖", "神里绫人", "神里绫华", "罗莎莉亚", "胡桃", "芭芭拉", "荒泷一斗", "莫娜", "菲谢尔", "行秋", "诺艾尔", "辛焱", "达达利亚", "迪卢克", "迪奥娜", "重云", "钟离", "阿贝多", "雷泽", "雷电将军", "香菱", "魈", "夜兰", "久岐忍", "鹿野院平藏"]  # 角色名称列表
...
for i in range(0, len(chara_name_list)):
    ...
    if chara_name_list[i] == "旅行者（无属性）":  # 官方只放出了无属性立绘，所以优化了一下提示内容
        chara_name_list[i] = "旅行者"
    else:
        pass
